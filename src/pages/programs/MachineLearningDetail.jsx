...
import classifyImg from "../../assets/classifyml.jpg";
import timeseriesImg from "../../assets/timeseriesml.jpg";
import recommendationImg from "../../assets/recomendationml.jpg";
...
const MachineLearningDetail = () => {
  ...
  const highlights = [
    ...
    "Foundation of Linear Algebra & Probability",
  ...
  const courseDetails = [
    {
      ...
      topics: ["Linear Algebra", "Probability Theory", "Optimization", "Algorithm Design"]
    },
    {
      title: "Deep Learning",
      topics: ["Neural Networks", "CNN Architectures", "RNN & LSTM", "Transformer Models"]
    },
    {
      title: "Advanced ML",
      topics: ["Ensemble Methods", "Bayesian Learning", "Reinforcement Learning", "Graph Neural Networks"]
    },
    {
      title: "ML Engineering",
      topics: ["Model Deployment", "MLOps", "Performance Optimization", "Scalable ML Systems"]
    }
  ];
  ...
  const projects = [
    {
      ...
      imagePath: classifyImg
    },
    {
      title: "Time Series Forecasting",
      imagePath: timeseriesImg
    },
    {
      title: "Recommendation Engine",
      imagePath: recommendationImg
    }
  ];
            ...
            <div className="lg:pr-8">
              ...
              >
                ...
                <p className="text-gray-700 text-lg leading-relaxed">
                  Specialize in machine learning and artificial intelligence. Learn advanced algorithms, neural networks, 
                  and predictive modeling techniques. This program focuses on the mathematical foundations and practical implementation of ML systems.
                </p>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="flex justify-center lg:pl-8">
              <div className="relative w-80 h-80">
                ...
                <div className="absolute top-12 left-12 w-6 h-6 bg-red-500 rounded-full animate-pulse"></div>
                <div className="absolute top-24 right-16 w-4 h-4 bg-red-400 rounded-full animate-pulse" style={{animationDelay: '0.5s'}}></div>
                <div className="absolute bottom-32 left-20 w-8 h-8 bg-red-600 rounded-full animate-pulse" style={{animationDelay: '1s'}}></div>
                <div className="absolute bottom-16 right-12 w-4 h-4 bg-red-400 rounded-full animate-pulse" style={{animationDelay: '1.5s'}}></div>
                <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-10 h-10 bg-red-700 rounded-full animate-pulse" style={{animationDelay: '0.3s'}}></div>
              </div>
            </div>
