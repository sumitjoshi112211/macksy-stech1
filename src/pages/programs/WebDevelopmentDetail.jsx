...
const WebDevelopmentDetail = () => {
  ...
  const highlights = [
    ...
    "Foundation of HTML, CSS & JavaScript",
    "React.js and Modern Frameworks",
    "Advanced Frontend & Backend Technologies"
  ];
  ...
  const courseDetails = [
    ...
    },
    {
      ...
      topics: ["React.js Components", "State Management", "Vue.js Basics", "Angular Introduction"]
    },
    {
      title: "Backend Development",
      topics: ["Node.js & Express", "RESTful APIs", "Database Design", "Authentication"]
    },
    {
      title: "Advanced Topics",
      topics: ["Performance Optimization", "Security Best Practices", "Testing & Debugging", "Deployment Strategies"]
    }
  ];
  ...
  const projects = [
    {
      ...
      imagePath: "/src/assets/online..jpg"
    },
    {
      title: "Design a BMI Calculator",
      imagePath: "/src/assets/bmi.jpg"
    },
    {
      title: "Design a Quiz App",
      imagePath: "/src/assets/quiz.jpg"
    }
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="flex justify-center lg:pl-8">
              <div className="relative w-80 h-80">
                ...
                <div className="absolute top-12 left-12 w-6 h-6 bg-blue-500 rounded-full animate-pulse"></div>
                <div className="absolute top-24 right-16 w-4 h-4 bg-blue-400 rounded-full animate-pulse" style={{animationDelay: '0.5s'}}></div>
                <div className="absolute bottom-32 left-20 w-8 h-8 bg-blue-600 rounded-full animate-pulse" style={{animationDelay: '1s'}}></div>
                <div className="absolute bottom-16 right-12 w-4 h-4 bg-blue-400 rounded-full animate-pulse" style={{animationDelay: '1.5s'}}></div>
                <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-10 h-10 bg-blue-700 rounded-full animate-pulse" style={{animationDelay: '0.3s'}}></div>
              </div>
            </div>
