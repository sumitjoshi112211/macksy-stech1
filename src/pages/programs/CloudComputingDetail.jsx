...
import CloudProjects from "../../components/cloudProjects/CloudProjects";
  ...
  const courseDetails = [
    {
      ...
      topics: ["Cloud Computing Basics", "AWS Core Services", "Azure Fundamentals", "Google Cloud Platform"]
    },
    {
      title: "Architecture & Design",
      topics: ["Well-Architected Framework", "Design Patterns", "Microservices", "Serverless Computing"]
    },
    {
      title: "DevOps Practices",
      topics: ["CI/CD Pipelines", "Infrastructure as Code", "Container Orchestration", "Monitoring & Logging"]
    },
    {
      title: "Security & Compliance",
      topics: ["Cloud Security Best Practices", "Identity Management", "Data Protection", "Compliance Standards"]
    }
  ];
            ...
            <div className="lg:pr-8">
              ...
              >
                ...
                <p className="text-gray-700 text-lg leading-relaxed">
                  Master cloud architecture and deployment strategies for modern applications. 
                  Learn to design, implement, and manage scalable cloud solutions. 
                  This program covers major cloud platforms and best practices for enterprise deployment.
                </p>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="lg:pr-8">
              <div className="space-y-6">
                {highlights.map((item, index) => (
                  ...
                  >
                    <div className="w-3 h-3 bg-cyan-600 rounded-full mt-2 shrink-0"></div>
            ...
            <div className="flex justify-center lg:pl-8">
              <div className="relative w-80 h-80">
                ...
                <div className="absolute top-12 left-12 w-6 h-6 bg-cyan-500 rounded-full animate-pulse"></div>
                <div className="absolute top-24 right-16 w-4 h-4 bg-cyan-400 rounded-full animate-pulse" style={{animationDelay: '0.5s'}}></div>
                <div className="absolute bottom-32 left-20 w-8 h-8 bg-cyan-600 rounded-full animate-pulse" style={{animationDelay: '1s'}}></div>
                <div className="absolute bottom-16 right-12 w-4 h-4 bg-cyan-400 rounded-full animate-pulse" style={{animationDelay: '1.5s'}}></div>
                <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-10 h-10 bg-cyan-700 rounded-full animate-pulse" style={{animationDelay: '0.3s'}}></div>
              </div>
            </div>
      ...
      <footer className="w-full bg-gray-900 text-white py-12">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
            <p>&copy; 2024 Macky's Tech  Ltd. All rights reserved.</p>
          </div>
        </div>
      </footer>
...
export default CloudComputingDetail;
