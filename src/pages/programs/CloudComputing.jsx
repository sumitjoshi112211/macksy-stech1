...
import cloudBg from "../../assets/CloudComputing.jpg";
      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center px-4 py-20">
        ...
        >
          ...
          <p className="text-gray-700 text-base md:text-lg leading-relaxed text-center mb-12">
            ...
            Learn to design, deploy, and manage scalable cloud solutions across major platforms. 
            This program prepares you for cloud certifications and real-world challenges.
          </p>
          ...
          <div className="mb-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {learnPoints.map((point, index) => (
                ...
                >
                  <div className="w-2 h-2 bg-cyan-600 rounded-full mt-2 shrink-0"></div>
