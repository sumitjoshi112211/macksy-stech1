...
import socialMediaImg from "../../assets/socialmediadigital.jpg";
import seoImg from "../../assets/SEOoptimizationdigital.jpg";
import contentImg from "../../assets/contentmarketing.jpg";
...
const DigitalMarketingDetail = () => {
  ...
  const [highlightsAnimated, setHighlightsAnimated] = useState(false);
  ...
  const highlights = [
    ...
    "Foundation of SEO & SEM Strategies",
  ...
  const courseDetails = [
    {
      ...
      topics: ["Digital Marketing Overview", "Consumer Behavior", "Market Research", "Brand Strategy"]
    },
    {
      title: "Search Marketing",
      topics: ["SEO Fundamentals", "Keyword Research", "Google Ads", "Content Marketing"]
    },
    {
      title: "Social Media Marketing",
      topics: ["Facebook Marketing", "Instagram Strategy", "LinkedIn Marketing", "Twitter Marketing"]
    },
    {
      title: "Analytics & Optimization",
      topics: ["Google Analytics", "Conversion Optimization", "A/B Testing", "ROI Measurement"]
    }
  ];
            ...
            <div className="lg:pr-8">
              ...
              >
                ...
                <p className="text-gray-700 text-lg leading-relaxed">
                  Master the art and science of digital marketing. Learn to create effective marketing campaigns, 
                  optimize for search engines, leverage social media platforms, and analyze marketing data. 
                  This program covers all essential digital marketing channels and strategies.
                </p>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="flex justify-center lg:pl-8">
              <div className="relative w-80 h-80">
                ...
                <div className="absolute top-24 right-16 w-4 h-4 bg-green-400 rounded-full animate-pulse" style={{animationDelay: '0.5s'}}></div>
                <div className="absolute bottom-32 left-20 w-8 h-8 bg-green-600 rounded-full animate-pulse" style={{animationDelay: '1s'}}></div>
                <div className="absolute bottom-16 right-12 w-4 h-4 bg-green-400 rounded-full animate-pulse" style={{animationDelay: '1.5s'}}></div>
                <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-10 h-10 bg-green-700 rounded-full animate-pulse" style={{animationDelay: '0.3s'}}></div>
              </div>
            </div>
